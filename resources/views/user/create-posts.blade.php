                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="shadow overflow-hidden border border-gray-400 sm:rounded-lg p-8">
                        ...
                        <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="py-5">
                                <input type="text" name="title" placeholder="Title..." class="w-full form-input" value="{{ old('title') }}">
                            </div>

                            <div class="py-5">
                                <textarea name="content" placeholder="Description..." rows="5" class="form-textarea w-full">{{ old('content') }}</textarea>
                            </div>
